...
const FUND_DATA = {
    ...
    attribution: {
        ...
        netTilt: [
            { name: "Industrial",         pct: 45.27 },
            { name: "Financials",         pct: 43.94 },
            { name: "Healthcare",         pct: 31.18 },
            { name: "Utilities",          pct: 30.43 },
            { name: "Telecomm",           pct: 18.39 },
            { name: "Basic Materials",    pct: 16.69 },
            { name: "Consumer Non-Cyc",   pct: 8.94 },
            { name: "Energy",             pct: 8.18 },
            { name: "Consumer Cyclicals", pct: 4.57 },
            { name: "Technology",         pct: -86.01 },
        ],

        // Five largest positions by absolute size, as % of NAV.
        topPositions: [
            { ticker: "DELL", side: "Short", pctNav: 13.3, move: -7.87 },
            { ticker: "CRM",  side: "Short", pctNav: 12.1, move: -3.41 },
            { ticker: "CEG",  side: "Long",  pctNav: 12.0, move:  2.16 },
            { ticker: "UBER", side: "Long",  pctNav: 11.9, move: -0.52 },
            { ticker: "NVDA", side: "Short", pctNav: 11.9, move: -4.36 },
        ],
        ...
        // a large one. Equities only; the option positions are a rounding error
        // in size and would otherwise dominate both ends on percentage.
        contributors: [
    ...
    positions: {
        longs: [
            { ticker: "CEG",  quantity: 600,   price: 298.96, pctNav: 11.97 },
            { ticker: "UBER", quantity: 2350,  price: 75.70,  pctNav: 11.88 },
            { ticker: "INTC", quantity: 1850,  price: 95.89,  pctNav: 11.84 },
            { ticker: "GOOG", quantity: 500,   price: 335.72, pctNav: 11.21 },
            { ticker: "VST",  quantity: 1050,  price: 149.79, pctNav: 10.50 },
            { ticker: "NVO",  quantity: 3250,  price: 46.50,  pctNav: 10.09 },
            { ticker: "KKR",  quantity: 1400,  price: 107.73, pctNav: 10.07 },
            { ticker: "UNH",  quantity: 375,   price: 397.14, pctNav: 9.94 },
            { ticker: "IONQ", quantity: 3600,  price: 39.73,  pctNav: 9.55 },
            { ticker: "BX",   quantity: 1050,  price: 136.15, pctNav: 9.54 },
            { ticker: "NOC",  quantity: 265,   price: 514.98, pctNav: 9.11 },
            { ticker: "SPOT", quantity: 250,   price: 542.43, pctNav: 9.05 },
            { ticker: "WMT",  quantity: 1250,  price: 107.14, pctNav: 8.94 },
            { ticker: "APO",  quantity: 1000,  price: 133.67, pctNav: 8.92 },
            { ticker: "AVAV", quantity: 900,   price: 145.91, pctNav: 8.77 },
            { ticker: "OSCR", quantity: 4000,  price: 32.25,  pctNav: 8.61 },
            { ticker: "LMT",  quantity: 245,   price: 526.23, pctNav: 8.61 },
            { ticker: "LHX",  quantity: 500,   price: 256.45, pctNav: 8.56 },
            { ticker: "MP",   quantity: 2350,  price: 54.46,  pctNav: 8.54 },
            { ticker: "KTOS", quantity: 2650,  price: 47.82,  pctNav: 8.46 },
            { ticker: "ASTS", quantity: 2000,  price: 62.08,  pctNav: 8.29 },
            { ticker: "COST", quantity: 135,   price: 915.74, pctNav: 8.25 },
            { ticker: "FSLR", quantity: 600,   price: 204.45, pctNav: 8.19 },
            { ticker: "USAR", quantity: 7000,  price: 17.44,  pctNav: 8.15 },
            { ticker: "TLN",  quantity: 375,   price: 318.50, pctNav: 7.97 },
            { ticker: "JBLU", quantity: 25000, price: 4.63,   pctNav: 7.73 },
            { ticker: "META", quantity: 175,   price: 615.20, pctNav: 7.19 },
            { ticker: "INFQ", quantity: 8000,  price: 12.85,  pctNav: 6.86 },
            { ticker: "IBKR", quantity: 1100,  price: 92.65,  pctNav: 6.80 },
            { ticker: "LULU", quantity: 1000,  price: 100.61, pctNav: 6.72 },
            { ticker: "CRSP", quantity: 1750,  price: 55.99,  pctNav: 6.54 },
            { ticker: "RKLB", quantity: 1400,  price: 64.26,  pctNav: 6.01 },
            { ticker: "XE",   quantity: 4010,  price: 17.75,  pctNav: 4.75 },
            { ticker: "HIMS", quantity: 2500,  price: 27.82,  pctNav: 4.64 },
        ],
        shorts: [
            { ticker: "DELL", quantity: -380,  price: 522.44, pctNav: 13.25 },
            { ticker: "CRM",  quantity: -700,  price: 259.23, pctNav: 12.11 },
            { ticker: "NVDA", quantity: -775,  price: 229.49, pctNav: 11.87 },
            { ticker: "TEAM", quantity: -925,  price: 189.85, pctNav: 11.72 },
            { ticker: "AMD",  quantity: -360,  price: 477.57, pctNav: 11.48 },
            { ticker: "MSTR", quantity: -1150, price: 142.58, pctNav: 10.95 },
            { ticker: "CRWD", quantity: -750,  price: 213.20, pctNav: 10.67 },
            { ticker: "ORCL", quantity: -1000, price: 159.70, pctNav: 10.66 },
            { ticker: "ROKU", quantity: -1000, price: 155.59, pctNav: 10.39 },
            { ticker: "NOW",  quantity: -1100, price: 141.26, pctNav: 10.37 },
            { ticker: "NET",  quantity: -500,  price: 278.92, pctNav: 9.31 },
            { ticker: "HOOD", quantity: -1100, price: 122.10, pctNav: 8.97 },
            { ticker: "SNDK", quantity: -75,   price: 1734.01, pctNav: 8.68 },
            { ticker: "SNOW", quantity: -350,  price: 338.03, pctNav: 7.90 },
            { ticker: "NBIS", quantity: -500,  price: 225.12, pctNav: 7.51 },
            { ticker: "BE",   quantity: -400,  price: 266.18, pctNav: 7.11 },
            { ticker: "TWLO", quantity: -400,  price: 232.98, pctNav: 6.22 },
        ],
        options: [
            { ticker: "MU",   contract: "Dec 18 '26 · 850 Put",  quantity: 1,   price: 56.80, pctNav: 0.38 },
            { ticker: "SPCE", contract: "Oct 16 '26 · 3 Put",    quantity: 100, price: 0.29,  pctNav: 0.19 },
            { ticker: "DELL", contract: "Dec 18 '26 · 320 Put",  quantity: 1,   price: 6.24,  pctNav: 0.04 },
            { ticker: "XE",   contract: "Oct 16 '26 · 20 Put",   quantity: -30, price: 3.58,  pctNav: 0.72 },
            { ticker: "XE",   contract: "Oct 16 '26 · 30 Put",   quantity: -20, price: 12.41, pctNav: 1.66 },
        ],
    },
};
